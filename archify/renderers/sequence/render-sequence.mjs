...
import { sigilSafeLabelFitWidth, brandMetadataFor, brandTopRailProblem, renderBrandMark } from '../shared/brand-marks.mjs';
...
function renderParticipant(participant) {
  ...
  const labelFontSize = fittedNodeFontSize(participant.label, sigilSafeLabelFitWidth(participant, layout.participantW), 11, 8);
  const passport = {
